...
<section class="post_container">
  <div class="loop_pages">
    <div class="page_name">
      <i class="fa fa-search"></i> Buscaste: <?php the_search_query(); ?>
    </div>
  </div>
<div class="search_page"><?php get_search_form(); ?></div>
<?php if (have_posts()) :  while (have_posts()) : the_post(); ?>
  ...
  <!--Si no hay entradas-->
   <?php get_template_part( 'template-parts/content', 'noresult' ); ?>
